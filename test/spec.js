...
module.exports = function(options) {
  ...
  describe('querying', function() {
    ...
    it('should read all the records', function(done) {
      db
        .query(sv.build('SELECT * FROM ' + db.wrap('CADASTRO')).query)
    ...
    it('should read all the records using like', function(done) {
      var view = sv.build('SELECT * FROM ' + db.wrap('CADASTRO'), {where: {NUMERO: {like: '%YTST'}}});
      db
        .query(view.query, view.params)
        .then(function(recordset) {
          expect(recordset).to.be.a('array');
  ...
  //    db
  //      .query(sv.build('SELECT * FROM ' + db.wrap('CADASTRO'), {
  //        where: {
  //          NUMERO: 'QRYTST'
  //        },
  //        limit: 3,
